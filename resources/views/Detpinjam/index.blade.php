        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="title_right">
              ...
              <br/>
              <a href="/peminjaman/cetak_pdf" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</a>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Peminajamn Buku</h2>
                  ...
                  <div class="x_content">
                    ...
                    <th scope="col">Action</th>
                      ...
                      <tbody>
                    @foreach($detail_peminjaman as $e)
                    <tr>
                    <td scope="col">{{$e->Kode_buku}}</td>
                    <td scope="col">{{$e->Id_peminjaman}}</td>
                    <td scope="col">{{$e->Status_peminjaman}}</td>
                    <td scope="col">{{$e->Denda_perbuku}}</td>
                    <td scope="col">{{$e->Tanggal_haruskembali}}</td>
                    <td scope="col">{{$e->Tanggal_kembali}}</td>
                    <td scope="col">{{$e->Perpanjangan}}</td>
                    <td scope="col">{{$e->Status_verifikasi}}</td>
                    <td> 
                    <a href="/detpinjam/edit/{{$e->Id_peminjaman}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/detpinjam/hapus/{{$e->Id_peminjaman}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a>
                    <a href="/detpinjam/edit1/{{$e->Id_peminjaman}}" class="btn btn-primary btn-xs"><i class="fa fa-check-square"></i>Pengembalian</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
