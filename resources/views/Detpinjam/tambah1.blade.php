  ...
  <body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah Peminjaman buku</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/detpinjam/store1" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kode buku</label>
        <div class="col-sm-10">
        <select name="Kode_buku" id="Kode_buku" class="form-control">
          <option value="" disabled selected>Ubah kode buku</option>
          @foreach ($eksemplar_buku as $a)
          <option value="{{ $a->Kode_buku }}" >{{ $a->No_ISBN }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <select name="Id_peminjaman" id="Id_peminjaman" class="form-control">
          ...
          <option value="{{ $a->Id_peminjaman }}" >{{ $a->Id_peminjaman }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Status_peminjaman" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Denda</label>
        <div class="col-sm-10">
        <input type="text" name="Denda_perbuku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tanggal harus kembali</label>
        <div class="col-sm-10">
        <input type="date" name="Tanggal_haruskembali" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Perpanjangan" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Status verifikasi</label>
        <div class="col-sm-10">
        <input type="text" name="Status_verifikasi" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
          <div class="modal-footer">
      <div class="col-sm-12">
        <a href="/buku" class="btn btn-white">Selesai</a>
        <input type="submit" class="btn btn-success" value="Simpan dan selesai">
        </div></div>
