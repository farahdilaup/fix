            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form action="/detpinjam/update1" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kode buku</label>
        <div class="col-sm-10">
<input type="text" name="Kode_buku" required="required" class="form-control" value="{{ $p->Kode_buku }}" readonly="readonly">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Id peminjaman</label>
        <div class="col-sm-10">
<input type="text" name="Id_peminjaman" required="required" class="form-control" value="{{ $p->Id_peminjaman }}" readonly="readonly">
    </div></div>
    <br/>
    <div class="item form-group">
