  ...
  <body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir edit penggantian buku</h2>
                ...
                <div class="x_content">
                  <br />
                   @foreach($penggantian_buku as $p)
                  <form action="/penggantian/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <select name="Kode_buku" id="Kode_buku" class="form-control">
          ...
          <option value="{{ $a->Kode_buku }}" {{$penggantian_buku[0]->Kode_buku == $a->Kode_buku ? 'selected' :""}}  >{{ $a->No_ISBN }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kode anggota</label>
        <div class="col-sm-10">
        <select name="Id_peminjaman" id="Id_peminjaman" class="form-control">
          <option value="" disabled selected>Ubah anggota</option>
          @foreach ($peminjaman as $a)
          <option value="{{ $a->Id_peminjaman }}" {{$penggantian_buku[0]->Id_peminjaman == $a->Id_peminjaman ? 'selected' :""}} >{{ $a->NIS_NIP }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jenis penggantian</label>
        <div class="col-sm-10">
        <input type="text" name="Jenis_penggantian" required="required" class="form-control" value="{{ $p->Jenis_penggantian }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jumlah</label>
        <div class="col-sm-10">
        <input type="text" name="Jumlah_uang_buku" required="required" class="form-control" value="{{ $p->Jumlah_uang_buku }}">
    </div></div>
    <br/>
