        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="title_right">
              ...
              <a href="/penggantian/tambah" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
              </div>
              </div>
              <br/>
            <a href="/penggantian/cetak_pdf" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</a>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel penggantian Buku</h2>
                  ...
                  <div class="x_content">
                    ...
                    <td> 
                    <a href="/penggantian/edit/{{$pu->Id_penggantian}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/penggantian/hapus/{{$pu->Id_penggantian}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
