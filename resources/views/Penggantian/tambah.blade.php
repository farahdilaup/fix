  ...
  <body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah penggantian buku</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/penggantian/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <select name="Id_peminjaman" id="Id_peminjaman" class="form-control">
          ...
          <option value="{{ $a->Id_peminjaman }}" >{{ $a->NIS_NIP }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Jenis_penggantian" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jumlah</label>
        <div class="col-sm-10">
        <input type="text" name="Jumlah_uang_buku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
