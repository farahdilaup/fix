        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah penerimaan</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/penerimaan/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
     <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Nama pegawai</label>
        <div class="col-sm-10">
        <select name="NIP" id="NIP" class="form-control">
          <option value="" disabled selected>Ubah Nama pegawai</option>
          @foreach ($pegawai as $a)
          <option value="{{ $a->NIP }}" >{{ $a->Nama_pegawai }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Asal</label>
        <div class="col-sm-10">
        <select name="Id_asal" id="Id_asal" class="form-control">
          <option value="" disabled selected>Ubah Asal</option>
          @foreach ($asal as $a)
          <option value="{{ $a->Id_asal }}" >{{ $a->asal }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tanggal penerimaan</label>
        <div class="col-sm-10">
        <input type="date" name="Tanggal_penerimaan" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jumlah buku</label>
        <div class="col-sm-10">
        <input type="text" name="Jumlah_buku_diterima" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Keterangan</label>
        <div class="col-sm-10">
        <input type="text" name="Keterangan" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
