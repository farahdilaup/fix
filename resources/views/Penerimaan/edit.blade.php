...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir edit penerimaan</h2>
                ...
                <div class="x_content">
                  ...
                  <form action="/penerimaan/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
     ...
     <div class="item form-group">
        ...
        <select name="NIP" id="NIP" class="form-control">
          ...
          <option value="{{ $a->NIP }}" {{$penerimaan[0]->NIP == $a->NIP ? 'selected' :""}} >{{ $a->Nama_pegawai }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="date" name="Tanggal_penerimaan" required="required" class="form-control" value="{{ $p->Kondisi_eksemplar_buku }}" readonly="readonly">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jumlah buku</label>
        <div class="col-sm-10">
        <input type="text" name="Jumlah_buku_diterima" required="required" class="form-control" value="{{ $p->Jumlah_buku_diterima }}">
    </div></div>
    <br/>
    <div class="item form-group">
