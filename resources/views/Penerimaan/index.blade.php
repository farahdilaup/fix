              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <td> 
                    <a href="/penerimaan/edit/{{$pn->Id_penerimaan}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/penerimaan/hapus/{{$pn->Id_penerimaan}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
