  ...
  <body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah penerimaan buku</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/detterima/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <select name="Id_penerimaan" id="Id_penerimaan" class="form-control">
          <option value="" disabled selected>Ubah Id asalN</option>
          @foreach ($penerimaan as $a)
          <option value="{{ $a->Id_penerimaan }}" >{{ $a->Id_asal }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <select name="No_ISBN" id="No_ISBN" class="form-control">
          ...
          @foreach ($buku as $a)
          <option value="{{ $a->No_ISBN }}" >{{ $a->Judul_buku }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Jumlah_eksemplar_perbuku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
