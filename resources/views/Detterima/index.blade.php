        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="title_right">
              ...
              <a href="/penerimaan/tambah" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
              </div>
              </div>
              <br/>
              <div class="title_right">
              <div class="col-md-12 col-sm-12">
              <a href="/detterima/tambah" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah Detail penerimaan </a>
              </div>
              </div>
            <a href="/penerimaan/cetak_pdf" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</a>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Penerimaan Buku</h2>
                  ...
                  <div class="x_content">
                    ...
                    <th scope="col">Action</th>
                      ...
                      <tbody>
                    @foreach($detail_penerimaan as $e)
                    <tr>
                    <td scope="col">{{$e->Id_penerimaan}}</td>
                    <td scope="col">{{$e->No_ISBN}}</td>
                    <td scope="col">{{$e->Jumlah_eksemplar_perbuku}}</td>
                    <td> 
                    <a href="/detterima/edit/{{$e->Id_penerimaan}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/detterima/hapus/{{$e->Id_penerimaan}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
