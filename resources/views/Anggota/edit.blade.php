...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form action="/anggota/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">NIS</label>
        <div class="col-sm-10">
        <input type="text" name="NIS_NIP" required="required" class="form-control"  value="{{ $p->NIS_NIP }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Nama anggota</label>
        <div class="col-sm-10">
        <input type="text" name="Nama_anggota" required="required" class="form-control" value="{{ $p->Nama_anggota }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tahun masuk</label>
        <div class="col-sm-10">
        <input type="date" name="Tahun_masuk" required="required" class="form-control" value="{{ $p->Tahun_masuk }}">
    </div></div>
    <br/>
    <div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Username_anggota" required="required" class="form-control" value="{{ $p->Username_anggota }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Password</label>
        <div class="col-sm-10">
        <input type="text" name="Password_anggota" required="required" class="form-control" value="{{ $p->Password_anggota }}">
    </div></div>
    <br/>
