              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <td> 
                    <a href="/anggota/edit/{{$ag->NIS_NIP}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/anggota/hapus/{{$ag->NIS_NIP}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
