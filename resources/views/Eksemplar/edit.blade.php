          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
@foreach($eksemplar_buku as $p)
<form action="/eksemplar/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <select name="No_ISBN" id="No_ISBN" class="form-control">
          ...
          @foreach ($buku as $a)
          <option value="{{ $a->No_ISBN }}" {{$eksemplar_buku[0]->No_ISBN == $a->No_ISBN ? 'selected' :""}} >{{ $a->Judul_buku }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Status eksemplar</label>
        <div class="col-sm-10">
         <input type="text" required="required" class="form-control" name="Status_eksemplar_buku" value="{{ $p->Status_eksemplar_buku }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kondisi</label>
        <div class="col-sm-10">
        <input type="text" required="required" class="form-control" name="Kondisi_eksemplar_buku" value="{{ $p->Kondisi_eksemplar_buku }}">
    </div></div>
    <br/>
