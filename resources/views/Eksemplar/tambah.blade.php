...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah eksemplar</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/eksemplar/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Status_eksemplar_buku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kondisi</label>
        <div class="col-sm-10">
        <input type="text" name="Kondisi_eksemplar_buku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
