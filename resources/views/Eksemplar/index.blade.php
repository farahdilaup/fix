        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="title_right">
              ...
              <a href="/eksemplar/tambah" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
              </div>
              </div>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <th scope="col">Kondisi eksemplar</th>
                    ...
                    <td> 
                    <a href="/eksemplar/edit/{{$e->Kode_buku}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/eksemplar/hapus/{{$e->Kode_buku}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
