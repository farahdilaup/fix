...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  @foreach ($buku as $p)
                  <form action="/buku/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">No ISBN</label>
        <div class="col-sm-10">
        <input type="text" name="No_ISBN" required="required" class="form-control"  value="{{ $p->No_ISBN }}" readonly="readonly">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Nama penerbit</label>
        <div class="col-sm-10">
        <select name="Id_penerbit" id="Id_penerbit" class="form-control">
          <option value="" disabled selected>Ubah Penerbit</option>
          @foreach ($penerbit as $a)
          <option value="{{ $a->Id_penerbit }}" {{$buku[0]->Id_penerbit == $a->Id_penerbit ? 'selected' :""}}>{{ $a->Nama_penerbit }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">jenis buku</label>
        <div class="col-sm-10">
        <select name="Id_jenis" id="Id_jenis" class="form-control">
          <option value="" disabled selected>Ubah Jenis</option>
          @foreach ($jenis_buku as $a)
          <option value="{{ $a->Id_jenis }}" {{$buku[0]->Id_jenis == $a->Id_jenis ? 'selected' :""}} >{{ $a->Nama_jenisbuku }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left"> bahasa</label>
        <div class="col-sm-10">
        <select name="Id_bahasa" id="Id_bahasa" class="form-control">
          <option value="" disabled selected>Ubah Bahasa</option>
          @foreach ($bahasa as $a)
          <option value="{{ $a->Id_bahasa }}" {{$buku[0]->Id_bahasa == $a->Id_bahasa ? 'selected' :""}} >{{ $a->Nama_bahasa }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Judul buku</label>
        <div class="col-sm-10">
        <input type="text" name="Judul_buku" required="required" class="form-control" value="{{ $p->Judul_buku }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tahun terbit</label>
        <div class="col-sm-10">
        <input type="date" name="Tahun_terbit" required="required" class="form-control" value="{{ $p->Tahun_terbit }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Penulis</label>
        <div class="col-sm-10">
        <input type="text" name="Penulis" required="required" class="form-control" value="{{ $p->Penulis }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Cetakan-ke</label>
        <div class="col-sm-10">
        <input type="text" name="Cetakan" required="required" class="form-control" value="{{ $p->Cetakan }}">
    </div></div>
    <br/>
    <div class="item form-group">
    ...
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Jumlah eksemplar</label>
        <div class="col-sm-10">
        <input type="text" name="Jumlah_eksemplar" required="required" class="form-control" value="{{ $p->Jumlah_eksemplar }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Kategori buku</label>
        <div class="col-sm-10">
        <input type="text" name="Kategori_buku"  required="required" class="form-control" value="{{ $p->Kategori_buku }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Status</label>
        <div class="col-sm-10">
        <input type="text" name="Status"  required="required" class="form-control" value="{{ $p->Status }}">
    </div></div>
    <br/>
