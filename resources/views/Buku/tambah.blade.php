  ...
  <body class="nav-md">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action="/buku/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">No ISBN</label>
        <div class="col-sm-10">
        <input type="text" name="No_ISBN" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <select name="Id_penerbit" id="Id_penerbit" class="form-control">
          ...
          <option value="{{ $a->Id_penerbit }}" >{{ $a->Nama_penerbit }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <select name="Id_jenis" id="Id_jenis" class="form-control">
          ...
          <option value="{{ $a->Id_jenis }}" >{{ $a->Nama_jenisbuku }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <select name="Id_bahasa" id="Id_bahasa" class="form-control">
          ...
          @foreach ($bahasa as $a)
          <option value="{{ $a->Id_bahasa }}" >{{ $a->Nama_bahasa }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Status"  required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
