            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form action="/penerbit/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Nama penerbit</label>
        <div class="col-sm-10">
        <input type="text" name="Nama_penerbit" required="required" class="form-control" value="{{ $p->Nama_penerbit }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Alamat penerbit</label>
        <div class="col-sm-10">
        <input type="text" name="Alamat_penerbit" required="required" class="form-control" value="{{ $p->Alamat_penerbit }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">No telp</label>
        <div class="col-sm-10">
        <input type="text" name="No_tlp_penerbit" required="required" class="form-control" value="{{ $p->No_tlp_penerbit }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Email</label>
        <div class="col-sm-10">
        <input type="text" name="Email_penerbit" required="required" class="form-control" value="{{ $p->Email_penerbit }}">
    </div></div>
    <br/>
