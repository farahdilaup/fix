        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="title_right">
              ...
              <a href="/penerbit/tambah" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
              </div>
              </div>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <tr>
                    <td scope="col">{{$pn->Id_penerbit}}</td>
                    <td scope="col">{{$pn->Nama_penerbit}}</td>
                    <td scope="col">{{$pn->Alamat_penerbit}}</td>
                    <td scope="col">{{$pn->No_tlp_penerbit}}</td>
                    <td scope="col">{{$pn->Email_penerbit}}</td>
                    <td> 
                    <a href="/penerbit/edit/{{$pn->Id_penerbit}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>EDIT</a>
                    <a href="/penerbit/hapus/{{$pn->Id_penerbit}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>HAPUS</a></td>
                    <p/>
                        </tr>
                        @endforeach
                      </tbody>
