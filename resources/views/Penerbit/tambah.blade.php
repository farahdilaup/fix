        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Formulir tambah penerbit</h2>
                ...
                <div class="x_content">
                  <br />
                  <form action="/penerbit/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                    {{csrf_field()}}
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Nama penerbit</label>
        <div class="col-sm-10">
        <input type="text" name="Nama_penerbit" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Alamat penerbit</label>
        <div class="col-sm-10">
        <input type="text" name="Alamat_penerbit" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">No telp</label>
        <div class="col-sm-10">
        <input type="text" name="No_tlp_penerbit" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Email</label>
        <div class="col-sm-10">
        <input type="text" name="Email_penerbit" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
