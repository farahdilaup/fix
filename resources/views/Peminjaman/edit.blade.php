...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form action="/peminjaman/update" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <br/>
     <div class="item form-group">
        ...
        <select name="NIP" id="NIP" class="form-control">
          ...
          <option value="{{ $a->NIP }}" {{$peminjaman[0]->NIP == $a->NIP ? 'selected' :""}} >{{ $a->Nama_pegawai }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Jumlah_buku" required="required" class="form-control" value="{{ $p->Jumlah_buku }}">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tanggal peminjaman</label>
        <div class="col-sm-10">
        <input type="date" name="Tanggal_peminjaman" required="required" class="form-control" value="{{ $p->Tanggal_peminjaman }}" readonly="readonly">
    </div></div>
    <br/>
