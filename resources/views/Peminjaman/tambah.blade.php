  ...
  <body class="nav-md">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action="/peminjaman/store" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <select name="NIS_NIP" id="NIS_NIP" class="form-control">
          <option value="" disabled selected>Ubah Nama anggota</option>
          @foreach ($anggota as $a)
          <option value="{{ $a->NIS_NIP }}" >{{ $a->Nama_anggota }}</option>
          @endforeach
        </select>
    </div></div>
    <br/>
    ...
    <div class="item form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="Jumlah_buku" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
    <div class="item form-group">
        <label class="col-sm-2 control-label text-left">Tanggal peminjaman</label>
        <div class="col-sm-10">
        <input type="date" name="Tanggal_peminjaman" required="required" class="form-control" placeholder="">
    </div></div>
    <br/>
          <div class="modal-footer">
      <div class="col-sm-12">
        <a href="/peminjaman" class="btn btn-white">Kembali</a>
